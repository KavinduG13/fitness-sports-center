...
const Services = () => {
  ...
  return (
    <section id="services" ref={sectionRef} className="bg-gray-50 dark:bg-[#141414] py-20 md:py-28 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-14 section-reveal">
          <div className="gold-accent-bar centered mb-4" />
          <h2 className="font-heading text-gray-900 dark:text-white text-5xl md:text-6xl mb-4">OUR SERVICES</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, i) => (
            <div
              key={service.id}
              className="section-reveal group relative rounded overflow-hidden cursor-pointer border border-gray-200 dark:border-dark-border hover:border-primary/50 transition-all duration-300 hover:scale-[1.03] hover:shadow-xl hover:shadow-primary/10"
