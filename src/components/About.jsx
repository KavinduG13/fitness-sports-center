...
const About = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className="bg-[#0a0a0a] py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          {/* Left: Text */}
          <div className="slide-left">
            <div className="gold-accent-bar mb-4" />
            <h2 className="font-heading text-white text-5xl md:text-6xl mb-8">ABOUT US</h2>
          ...
          <div className="slide-right">
            <div className="relative">
              ...
              <img
                ...
                className="relative z-10 w-full rounded object-cover border border-dark-border shadow-2xl aspect-[4/3]"
              />
              {/* Gold corner accent */}
