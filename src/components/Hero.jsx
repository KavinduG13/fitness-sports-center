const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen bg-[#0a0a0a] flex items-center pt-20 md:pt-24 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center py-12 md:py-20">
          ...
          <div className="slide-left visible-on-load">
            ...
            <h1 className="font-heading text-white text-6xl sm:text-7xl md:text-8xl leading-none mb-6">
              FORGE YOUR
              <br />
          ...
          <div className="slide-right visible-on-load flex justify-center md:justify-end">
            <div className="relative">
              ...
              <img
                ...
                className="relative z-10 w-full max-w-sm md:max-w-md lg:max-w-lg rounded object-cover border border-dark-border shadow-2xl"
              />
            </div>
          </div>
        </div>
